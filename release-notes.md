...
* 👷 Use GitHub CLI for Git authentication. PR [#132](https://github.com/fastapi/fastapi-new/pull/132) by [@tiangolo](https://github.com/tiangolo).
* 👷 Use PR Push commit identity. PR [#131](https://github.com/fastapi/fastapi-new/pull/131) by [@tiangolo](https://github.com/tiangolo).
* 🔒 Replace pre-commit PAT with PR Push. PR [#129](https://github.com/fastapi/fastapi-new/pull/129) by [@tiangolo](https://github.com/tiangolo).
* 🔥 Remove the old Latest Changes workflow. PR [#128](https://github.com/fastapi/fastapi-new/pull/128) by [@tiangolo](https://github.com/tiangolo).
* ⬆ Bump the python-packages group across 1 directory with 5 updates. PR [#124](https://github.com/fastapi/fastapi-new/pull/124) by [@dependabot[bot]](https://github.com/apps/dependabot).
* ⬆ Bump typer from 0.26.8 to 0.27.0. PR [#125](https://github.com/fastapi/fastapi-new/pull/125) by [@dependabot[bot]](https://github.com/apps/dependabot).
...
* 🔧 Set Dependabot schedule interval to "monthly". PR [#110](https://github.com/fastapi/fastapi-new/pull/110) by [@YuriiMotov](https://github.com/YuriiMotov).
...
* 🔧 Enable checking `release-notes.md` for typos. PR [#98](https://github.com/fastapi/fastapi-new/pull/98) by [@YuriiMotov](https://github.com/YuriiMotov).
* ⬆ Bump mxschmitt/action-tmate from 3.23 to 3.24 in the github-actions group. PR [#92](https://github.com/fastapi/fastapi-new/pull/92) by [@dependabot[bot]](https://github.com/apps/dependabot).
* ⬆ Bump the python-packages group across 1 directory with 2 updates. PR [#89](https://github.com/fastapi/fastapi-new/pull/89) by [@dependabot[bot]](https://github.com/apps/dependabot).
...
* 👷 Run tests with lower bound uv sync, upgrade minimum dependencies. PR [#41](https://github.com/fastapi/fastapi-new/pull/41) by [@YuriiMotov](https://github.com/YuriiMotov).
